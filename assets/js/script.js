...
var questions = [
    ...
    new Question(
        "Which tag is an extention to HTML that encloses any number of statements?",
        ["SCRIPT",
        "BODY", "HEAD",
        "TITLE"],
        "SCRIPT"
    ...
    new Question(
        ...
        ["a low-level programming language.",
            "a language precompiled in the browser.",
    ...
    new Question(
        "Which statement tests for a specific condition?",
        ["Select",
            "If",
                "Switch",
                    "For"],
    ...
    new Question(
        "Which answer describes what JavaScript entities start and and end with?",
        ["Semicolon, colon",
            "Semicolon, Ampersand",
                "Ampersand, colon",
                    "Ampersand, semicolon"],
...
//Start quiz when "start" button is pushed
